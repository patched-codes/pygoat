...
def csrf_lab_login(request):
    if request.method == 'GET':
        ...
        password = hashlib.scrypt(password.encode(), salt=os.environ.get('SALT').encode(), n=16384, r=8, p=1).hex()
        ...
        if User:
            ...
            cookie = jwt.encode(payload, os.environ.get('JWT_SECRET'), algorithm='HS256')
